    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <section className="py-16 md:py-24 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <h3 className="text-3xl font-bold tracking-tight md:text-4xl mb-4 dark:text-white">Our Tech Stack</h3>
          <p className="text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto">
            We use the latest and most reliable tools to build scalable, high-performing solutions for your business.
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            {["React", "Next.js", "Tailwind CSS", "Node.js", "Express", "MongoDB", "Firebase", "AWS"].map(
              (tech, index) => (
                <div
                  key={index}
                  className="px-4 py-2 rounded-full border border-green-500 text-green-700 dark:text-green-400 dark:border-green-400 text-sm font-medium"
                >
                  {tech}
                </div>
              )
